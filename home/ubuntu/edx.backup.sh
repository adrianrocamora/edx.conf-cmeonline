...
MYSQL_CONN="-uroot"
MONGODB_PWD="qlc9kFe7BzpAzWX6fzdTlXrFG3uBA6vBo1I"    #Add your MongoDB admin password from your my-passwords.yml file in the ubuntu home folder.

S3_BUCKET="cmeonline-backups-cdn/"  #For this script to work you'll first need the following:
